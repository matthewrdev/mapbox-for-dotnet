...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) TMBLayerType * _Nonnull model;)
+ (TMBLayerType * _Nonnull)model SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
///
/// The value of the property in the layer with layerId.
- (TMBStylePropertyValue * _Nonnull)layerPropertyFor:(NSString * _Nonnull)layerId property:(NSString * _Nonnull)property SWIFT_WARN_UNUSED_RESULT;
...
- (TMBStylePropertyValue * _Nonnull)layerPropertyDefaultValueFor:(TMBLayerType * _Nonnull)layerType property:(NSString * _Nonnull)property SWIFT_WARN_UNUSED_RESULT;
...
- (TMBStylePropertyValue * _Nonnull)sourcePropertyFor:(NSString * _Nonnull)sourceId property:(NSString * _Nonnull)property SWIFT_WARN_UNUSED_RESULT;
...
- (TMBStylePropertyValue * _Nonnull)sourcePropertyDefaultValueFor:(NSString * _Nonnull)sourceType property:(NSString * _Nonnull)property SWIFT_WARN_UNUSED_RESULT;
...
/// returns:
/// Style terrain property value.
- (TMBStylePropertyValue * _Nonnull)terrainProperty:(NSString * _Nonnull)property SWIFT_WARN_UNUSED_RESULT;
...
- (TMBStylePropertyValue * _Nonnull)atmosphereProperty:(NSString * _Nonnull)property SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC13MapboxMapObjC13TMBModelLayer")
@interface TMBModelLayer : NSObject <TMBLayer>
/// Unique layer name
@property (nonatomic, copy) NSString * _Nonnull id;
/// Rendering type of this layer.
@property (nonatomic, readonly, strong) TMBLayerType * _Nonnull type;
...
@property (nonatomic, strong) TMBValue * _Nonnull visibility;
/// Model to render.
@property (nonatomic, strong) TMBValue * _Nullable modelId;
/// Intensity of the ambient occlusion if present in the 3D model.
@property (nonatomic, strong) TMBValue * _Nullable modelAmbientOcclusionIntensity;
/// Transition options for <code>modelAmbientOcclusionIntensity</code>.
@property (nonatomic, strong) TMBStyleTransition * _Nullable modelAmbientOcclusionIntensityTransition;
/// Enable/Disable shadow casting for this layer
@property (nonatomic, strong) TMBValue * _Nullable modelCastShadows;
...
@property (nonatomic, strong) TMBValue * _Nullable modelColor;
/// Transition options for <code>modelColor</code>.
@property (nonatomic, strong) TMBStyleTransition * _Nullable modelColorTransition;
...
@property (nonatomic, strong) TMBValue * _Nullable modelColorMixIntensity;
/// Transition options for <code>modelColorMixIntensity</code>.
@property (nonatomic, strong) TMBStyleTransition * _Nullable modelColorMixIntensityTransition;
/// This parameter defines the range for the fade-out effect before an automatic content cutoff  on pitched map views. The automatic cutoff range is calculated according to the minimum required zoom level of the source and layer. The fade range is expressed in relation to the height of the map view. A value of 1.0 indicates that the content is faded to the same extent as the map’s height in pixels, while a value close to zero represents a sharp cutoff. When the value is set to 0.0, the cutoff is completely disabled. Note: The property has no effect on the map if terrain is enabled.
@property (nonatomic, strong) TMBValue * _Nullable modelCutoffFadeRange;
...
/// Transition options for <code>modelEmissiveStrength</code>.
@property (nonatomic, strong) TMBStyleTransition * _Nullable modelEmissiveStrengthTransition;
...
@property (nonatomic, strong) TMBValue * _Nullable modelHeightBasedEmissiveStrengthMultiplier;
/// Transition options for <code>modelHeightBasedEmissiveStrengthMultiplier</code>.
@property (nonatomic, strong) TMBStyleTransition * _Nullable modelHeightBasedEmissiveStrengthMultiplierTransition;
/// The opacity of the model layer.
@property (nonatomic, strong) TMBValue * _Nullable modelOpacity;
/// Transition options for <code>modelOpacity</code>.
@property (nonatomic, strong) TMBStyleTransition * _Nullable modelOpacityTransition;
/// Enable/Disable shadow receiving for this layer
@property (nonatomic, strong) TMBValue * _Nullable modelReceiveShadows;
/// The rotation of the model in euler angles [lon, lat, z].
@property (nonatomic, strong) TMBValue * _Nullable modelRotation;
/// Transition options for <code>modelRotation</code>.
@property (nonatomic, strong) TMBStyleTransition * _Nullable modelRotationTransition;
...
@property (nonatomic, strong) TMBValue * _Nullable modelRoughness;
/// Transition options for <code>modelRoughness</code>.
@property (nonatomic, strong) TMBStyleTransition * _Nullable modelRoughnessTransition;
/// The scale of the model.
@property (nonatomic, strong) TMBValue * _Nullable modelScale;
/// Transition options for <code>modelScale</code>.
@property (nonatomic, strong) TMBStyleTransition * _Nullable modelScaleTransition;
/// Defines scaling mode. Only applies to location-indicator type layers.
@property (nonatomic, strong) TMBValue * _Nullable modelScaleMode;
/// The translation of the model in meters in form of [longitudal, latitudal, altitude] offsets.
@property (nonatomic, strong) TMBValue * _Nullable modelTranslation;
/// Transition options for <code>modelTranslation</code>.
@property (nonatomic, strong) TMBStyleTransition * _Nullable modelTranslationTransition;
/// Defines rendering behavior of model in respect to other 3D scene objects.
@property (nonatomic, strong) TMBValue * _Nullable modelType;
- (nonnull instancetype)initWithId:(NSString * _Nonnull)id source:(NSString * _Nonnull)source OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// seealso:
/// <a href="https://www.mapbox.com/mapbox-gl-style-spec/#layers-slot">Mapbox Style Specification</a>
SWIFT_CLASS("_TtC13MapboxMapObjC12TMBSlotLayer")
@interface TMBSlotLayer : NSObject <TMBLayer>
- (nonnull instancetype)initWithId:(NSString * _Nonnull)id OBJC_DESIGNATED_INITIALIZER;
/// Unique layer name
@property (nonatomic, copy) NSString * _Nonnull id;
/// Rendering type of this layer.
...
enum TMBStylePropertyValueKind : NSInteger;
SWIFT_CLASS("_TtC13MapboxMapObjC21TMBStylePropertyValue")
@interface TMBStylePropertyValue : NSObject
@property (nonatomic, readonly) id _Nullable value;
@property (nonatomic, readonly) enum TMBStylePropertyValueKind kind;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end

typedef SWIFT_ENUM(NSInteger, TMBStylePropertyValueKind, open) {
  TMBStylePropertyValueKindUndefined = 0,
  TMBStylePropertyValueKindConstant = 1,
  TMBStylePropertyValueKindExpression = 2,
  TMBStylePropertyValueKindTransition = 3,
};
